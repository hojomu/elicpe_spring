...
<!-- End Profile Iamge Icon -->
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="http://localhost:8080/board/list">
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">자유게시판 <span>| Today</span></h5>

                  <table class="table table-borderless datatable">
                    <thead>
                      <tr>
                        <th class="board-text-align" scope="col">글번호</th>
                        <th scope="col">제목</th>
                        <th class="board-text-align" scope="col">작성자</th>
                        <th class="board-text-align" scope="col">작성일</th>
                        <th class="board-text-align" scope="col">조회</th>
                        <th class="board-text-align" scope="col">좋아요</th>
                      </tr>
                    </thead>
                    <tbody>
                    <!-- 게시글 리스트 for문 시작 -->
                      <c:forEach items="${list}" var="boardlist">
						<tr>
							<td class="board-text-align">${boardlist.board_no}</td>
							<td><a class="board-text-a" href="/board/detail?board_no=${boardlist.board_no}">${boardlist.title}</a></td>
							<td class="board-text-align">${boardlist.id}</td>
							<td class="board-text-align">${boardlist.updated_time}</td>
							<td class="board-text-align">${boardlist.counts}</td>
							<td class="board-text-align">${boardlist.likes}</td>
						</tr>
						</c:forEach>
                    <!-- 게시글 리스트 for문 끝 -->
                    </tbody>
              ...
              <ul class="pagination">
				...
				<c:forEach begin="${paging.startPage}" end="${paging.endPage}" var="num">
					<li class="page-item">
				 		<a class="page-link" href="/board/list?type=${paging.cri.type}&keyword=${paging.cri.keyword}&pageNum=${num}&amount=${paging.cri.amount}">${num}</a>
					</li>
				</c:forEach>
				...
				<c:if test="${paging.next}">
					<li class="page-item">
						<a class="page-link" href="/board/list?type=${paging.cri.type}&keyword=${paging.cri.keyword}&pageNum=${paging.endPage+1}&amount=${paging.cri.amount}">&raquo;</a>
					</li>
				</c:if>
			  </ul>
              	<!-- pagnation 끝 -->
