              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" action="/login" method="post">
                    ...
                    <div class="col-12">
                      <p class="small mb-0">회원이 아니신가요? <a href="http://localhost:8080/member">회원가입 바로가기</a></p>
                    </div>
                  </form>
...
<!-- <div class="login-box">
  ...
  <form action="http://localhost:8080/login" method="post">
    ...
    <button id="lginbtn"> 로그인</button>
    <button type="button" onclick="location.href='http://localhost:8080/member'" id="registebtn">회원가입</button>
  </form>
</div> -->
</body>
</html>
